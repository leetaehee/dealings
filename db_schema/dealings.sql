...
CREATE TABLE `imi_dealings` (
  `idx` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'imi_dealings.PK',
  `dealings_type` enum('구매','판매') NOT NULL COMMENT 'imi_dealings_code.idx FK 거래종류(판매/구매) ',
  ...
  `writer_idx` int(11) unsigned NOT NULL COMMENT '거래작성자 고유번호 imi_members.idx',
  `item_no` int(11) unsigned NOT NULL COMMENT 'imi_sell_item.idx FK',
  ...
  `dealings_status` int(11) unsigned NOT NULL COMMENT '거래 처리상태 imi_dealings_status_code.idx FK',
...
CREATE TABLE `imi_dealings_commission` (
  `idx` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'imi_dealings_commission.idx PK',
...
CREATE TABLE `imi_dealings_mileage_change` (
  `idx` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'imi_dealings_mileage_change.idx PK',
  `dealings_idx` int(11) unsigned NOT NULL COMMENT 'imi_dealings.idx PK',
  `dealings_writer_idx` int(11) unsigned NOT NULL COMMENT '거래글 작성자(imi_members.idx)',
  `dealings_member_idx` int(11) unsigned NOT NULL COMMENT '거래를 하는 사람(imi_members.idx)',
  `charge_idx` int(11) unsigned NOT NULL COMMENT 'imi_mileage_charge.idx FK',
  `dealings_status_code` int(11) unsigned NOT NULL COMMENT 'imi_dealings_status_code.idx FK',
...
CREATE TABLE `imi_dealings_process` (
  `idx` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'imi_dealings_process.idx PK',
  `dealings_idx` int(11) unsigned NOT NULL COMMENT 'imi_dealings.idx FK',
  `dealings_status_idx` int(11) unsigned NOT NULL COMMENT 'imi_dealings_status_code.idx FK',
...
CREATE TABLE `imi_dealings_status_code` (
  `idx` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'imi_dealings_status_code.PK idx',
...
CREATE TABLE `imi_dealings_user` (
  `idx` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'imi_dealings_user.idx PK',
  ...
  `dealings_status` int(11) unsigned NOT NULL COMMENT 'imi_dealings_status_code.idx 거래상태 ',
