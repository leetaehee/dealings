<?php
	...
	try {
		...
		$couponIssueList = $couponClass->getCouponIssueList();
		if ($couponIssueList === false) {
			throw new Exception('사용자 쿠폰 발행내역을 가져오다가 오류가 발생했습니다.');
		} 

		$couponIssueListCount = $couponIssueList->recordCount();
